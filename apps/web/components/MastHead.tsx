// ─────────────────────────────────────────────────────────────
// Masthead — the GLANCE tier. Identity + links on the left, the hero
// health numeral on the right. The one CornerFrame on the page, and the
// one display-font element (the big score).
// ─────────────────────────────────────────────────────────────
...
export function Masthead({ identity, health }: { identity: Identity; health: Health }) {
  ...
  // links minus the audits array, which renders as chips
