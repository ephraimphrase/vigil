...
async def fetch_tvl(protocol: str) -> Signal:
    """
    ...
    empty: Signal = {"tvl_current": 0, "tvl_delta_24h": 0.0, "tvl_delta_7d": 0.0}
...
async def _fetch_tvl_simple(slug: str, empty: Signal) -> Signal:
...
async def _fetch_tvl_with_deltas(slug: str, empty: Signal, protocol: str) -> Signal:
