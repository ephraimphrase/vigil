...
import "../interface/common/IWrappedNative.sol";
import "../interface/convex/IConvex.sol";
import "../interface/curve/ICrvMinter.sol";
import "../interface/curve/IRewardsGauge.sol";
...
contract StrategyCurveConvexL2Factory is BaseAllToNativeFactoryStrat {
    ...
    function initialize(address _gauge, uint256 _pid, address[] calldata _rewards, Addresses calldata _addresses)
        public
        initializer
    {
        gauge = _gauge;
