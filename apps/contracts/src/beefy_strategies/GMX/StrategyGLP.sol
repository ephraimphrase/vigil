...
import "../interface/gmx/IGMXTracker.sol";
import "../interface/gmx/IGLPManager.sol";
import "../interface/gmx/IBeefyVault.sol";
import "../interface/gmx/IGMXStrategy.sol";
import "../interface/gmx/IGMXGovToken.sol";
...
contract StrategyGLP is StratFeeManagerInitializable {
    ...
    function _removeAllowances() internal {
        IERC20(native).forceApprove(glpManager, 0);
        IERC20(gmx).forceApprove(unirouter, 0);
    }
