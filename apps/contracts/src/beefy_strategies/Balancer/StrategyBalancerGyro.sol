...
import "../interface/aura/IAuraRewardPool.sol";
import "../interface/aura/IAuraBooster.sol";
import "../interface/beethovenx/IBalancerVault.sol";
...
contract StrategyBalancerGyro is BaseAllToNativeFactoryStrat {
    ...
    function _claim() internal override {
        if (useAura) {
            ...
            try minter.mint(address(this)) { /* yay there is rewards */ } catch { /* If we are here there is no bal */ }
