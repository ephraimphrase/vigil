...
// SKELETON - Euler lending. Primary stablecoins: USDC, USDT.
// TODO: Euler v2 markets are EVaults, which are ERC4626-compliant - same
// integration shape as Yearn/Sommelier/MetaMorpho. protocolPool should be
// typed IERC4626 and point at the specific EVault for this asset.
contract EulerAdapter is IVigilProtocolAdapter {
