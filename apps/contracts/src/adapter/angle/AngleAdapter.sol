...
// SKELETON - Angle Protocol stablecoin savings. Primary: agEUR, USDA.
// TODO: yield comes from staking USDA into stUSD (an ERC4626-shaped savings
// wrapper), similar in shape to Sky's sUSDS. Note agEUR is euro-denominated,
// not USD - if this vault's underlying is a USD stablecoin, only the USDA
// side applies without an FX leg. protocolPool should be the stUSD contract.
contract AngleAdapter is IVigilProtocolAdapter {
