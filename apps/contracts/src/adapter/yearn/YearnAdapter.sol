...
// SKELETON - Yearn Finance vaults. Primary stablecoins: USDC, DAI, USDT.
// TODO: Yearn v3 vaults are standard ERC4626 - protocolPool should be typed
// IERC4626 and deposit/withdraw/totalAssets can delegate straight to
// deposit()/withdraw()/convertToAssets(), same shape as Euler, Sommelier,
// and Morpho Blue's MetaMorpho vaults elsewhere in this list.
contract YearnAdapter is IVigilProtocolAdapter {
