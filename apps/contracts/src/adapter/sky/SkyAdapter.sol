...
// SKELETON - Sky (formerly MakerDAO) Savings Rate. Primary: USDS, DAI.
// TODO: yield comes from the Sky Savings Rate module (sUSDS, successor to
// DSR/sDAI) - a simple deposit-for-rate mechanism, closer to a savings
// account than a lending market with utilization. protocolPool should be
// the sUSDS contract (or DSR Pot, if targeting legacy DAI/sDAI directly).
contract SkyAdapter is IVigilProtocolAdapter {
