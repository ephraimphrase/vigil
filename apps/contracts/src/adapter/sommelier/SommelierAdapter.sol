...
// SKELETON - Sommelier Finance managed Cellars. Primary: USDC, DAI.
// TODO: Cellars are ERC4626-compliant vaults, same integration shape as
// Yearn/Euler/MetaMorpho - but strategy risk sits with an offchain/keeper-
// managed rebalancer rather than a fixed protocol formula, worth reflecting
// in how this protocol gets scored by HealthOracle. protocolPool should be
// the specific Cellar address.
contract SommelierAdapter is IVigilProtocolAdapter {
