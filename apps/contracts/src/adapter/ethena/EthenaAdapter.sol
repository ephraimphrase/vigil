...
// SKELETON - Ethena synthetic dollar yield. Primary assets: USDe, sUSDe.
// TODO: yield comes from staking USDe into sUSDe (an ERC4626-shaped vault
// with a 7-day cooldown on unstaking in the real protocol) rather than a
// lending pool. protocolPool should be the sUSDe staking contract; withdraw
// paths need to account for the cooldown window, which the other
// lending-style adapters here don't have to model.
contract EthenaAdapter is IVigilProtocolAdapter {
