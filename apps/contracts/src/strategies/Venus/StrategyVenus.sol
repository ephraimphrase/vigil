...
import "../interface/common/IVToken.sol";
import "../interface/venus/IVenusComptroller.sol";
import "../interface/venus/IVenusRewarder.sol";
...
contract StrategyVenus is StratFeeManagerInitializable {
    ...
    function setReward(address _reward) external onlyOwner {
        ...
        IERC20(_reward).forceApprove(unirouter, type(uint256).max);
    }
