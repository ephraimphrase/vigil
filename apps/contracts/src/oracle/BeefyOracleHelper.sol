...
import {IBeefyOracle} from "../beefy_strategies/interface/oracle/IBeefyOracle.sol";
...
library BeefyOracleHelper {
    ...
    function priceFromBaseToken(address _oracle, address _token, address _baseToken, uint256 _amountOut)
        internal
    ...
    function scaleAmount(uint256 _amount, uint8 _decimals) internal pure returns (uint256 scaledAmount) {
